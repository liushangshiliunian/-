        ...
        <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position="top">
            <el-tabs v-model="activeIndex" :tab-position="'left'" :before-leave="beforeTabLeave" @tab-click="tabClicked">
                <el-tab-pane label="基本信息" name="0">
                    <el-form-item label="商品名称" prorp="goods_name">
                        <el-input v-model="addForm.goods_name"></el-input>
                    </el-form-item>
                    <el-form-item label="商品价格" prorp="goods_name">
                        <el-input v-model="addForm.goods_price" type="number"></el-input>
                    </el-form-item>
                    <el-form-item label="商品重量" prorp="goods_weight">
                        <el-input v-model="addForm.goods_name" type="number"></el-input>
                    </el-form-item>
                    <el-form-item label="商品数量" prorp="goods_number">
                        <el-input v-model="addForm.goods_name" type="number"></el-input>
                    </el-form-item>
                    <el-form-item label="商品分类" prorp="goods_cat">
                        <el-cascader expand-trigger="hover" :options="catelist" :props="cateProps" v-model="addForm.goods_cat" @change="handleChange">
                        </el-cascader>
                    </el-form-item>
                </el-tab-pane>

                <el-tab-pand label="商品参数" name="1">
  ...
  methods: {
      ...
      add() {
          this.$refs.addFormRef.validate(async valid => {
              ...
              form.goods_cat = form.goods_cat.jion(',')
